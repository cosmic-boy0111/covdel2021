...
const Food_store = [
    {
        id:'6',
        img:'https://b.zmtcdn.com/data/homepage_dish_data/4/76d788a2600b609bb0a08443e03df95b.png',
        name:'Biryani',
        rating:'5',
        prize:'99' ,
        qnt:'1',
    ...
    {
        id:'7',
        img:'https://b.zmtcdn.com/data/dish_images/c598d69f4864f3cba4b0de2d8efc0e521612436494.png',
        name:'pizza',
        rating:'4',
        prize:'99' ,
        qnt:'1',
...
// const Food_store = JSON.parse(localStorage.getItem('Food'))===null?[]:JSON.parse(localStorage.getItem('Food'));
