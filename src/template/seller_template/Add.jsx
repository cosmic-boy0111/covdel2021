...
const useStyles = makeStyles((theme) => ({
  ...
  const Add = () =>{
      ...
      const [rocker, setRocker] = useState(true);
          ...
          <>
                  <div className='add_new_product'>
                      ...
                      <div className='add2' style={{
                          display:rocker?'none':'flex'
                          }}>
                        <img src={Rocket} alt=""/>
                      </div>
                      <div className='add' style={{display:rocker?'flex':'none'}}>
                      <form onSubmit={Add_new}> 
                      <img src={img2} alt=""/>
                      <input accept="image/*"  className="form-control" className={classes.input} name='img' id="icon-button-file" type="file" onChange={imageHandler} required/>
